 ...
 * @author Gurjeet
 */
public class SubmitCoursework extends javax.swing.JFrame {
 
    /**
     * Creates new form studentSubmit
     */
    public SubmitCoursework() {
        initComponents();
    }
    /**
   ...
   //prevent student from leaving submission box blank when pressing submit 
   ...
   else
   {
        ...
        //align integer in the middle 
        result.setHorizontalAlignment(result.CENTER); 
        //call the method to bring up the text in the label
        referenceCode.setText("Reference Code"); 
        //align text in the centre 
        referenceCode.setHorizontalAlignment(referenceCode.CENTER);
        //call method to bring up the text in the label
        cwkStatus.setText("Submitted for grading"); 
        //align text in the centre of the label
        cwkStatus.setHorizontalAlignment(cwkStatus.CENTER);
        //once confirmation button is pressed disable it
        //same with addsubmissionbutton and modules
        //this only works if a document has been selected
        ...
        try{
            ...
            //establish the connection with login details
            Connection con = DriverManager.getConnection(db, "Admin1", "password");
            Statement ste = con.createStatement();
            //insert the value of the reference code and update status in
            //the tables once confirm button pressed
    ...
    private void addSubmissionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addSubmissionActionPerformed
        // TODO add your handling code here:
        //apply a filter so specific documents can only be selected 
        FileFilter ft = new FileNameExtensionFilter("Word docs","doc","docx");
        //make sure the filter is correct format 
        addCoursework.addChoosableFileFilter(ft);
        //open a box to choose coursework 
        int returnVal = addCoursework.showOpenDialog(this);
        //get selected coursework file and the name of the file
        //apply the name as a string and aligning to the centre
    ...
    private void okayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okayActionPerformed
        // TODO add your handling code here:
       noCwk.dispose(); // get rid of dialog box after selecting coursework
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SubmitCoursework.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
